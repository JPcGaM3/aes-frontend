...
export const SunIcon = (props: IconSvgProps) => {
	...
	return (
		<SunDim
			fill={variant === "fill" ? color : "none"}
			height={size}
			// Stroke should also respect the variant, or be "none" if filled
			stroke={variant === "border" ? color : "none"}
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={strokeWidth}
...
export const SearchIcon = (props: IconSvgProps) => {
	const {
		...
		strokeWidth = 1.5,
		color = "currentColor",
		// Search icon is typically stroked, so fill is usually "none"
		// If you want it to support 'fill' variant, add it here.
		variant = "border", // Assuming search is always bordered/stroked by default
		...rest
	} = props;
	...
	return (
		<Search
			height={size}
			stroke={variant === "border" ? color : "none"} // Stroke if variant is 'border'
			fill={variant === "fill" ? color : "none"} // Fill if variant is 'fill'
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={strokeWidth}
			viewBox="0 0 24 24"
...
export const PlusIcon = (props: IconSvgProps) => {
	const {
		...
		strokeWidth = 1.5,
		color = "currentColor",
		// Plus icon is typically stroked, so fill is usually "none"
		variant = "border", // Assuming plus is always bordered/stroked by default
		...rest
	} = props;
...
export const VerticalDotsIcon = (props: IconSvgProps) => {
	...
	return (
		<EllipsisVertical
			fill={variant === "fill" ? color : "none"}
			height={size}
			stroke={variant === "border" ? color : "none"} // Stroke should also respect the variant
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={strokeWidth}
			viewBox="0 0 24 24"
...
export const ChevronDownIcon = (props: IconSvgProps) => {
	...
	return (
		// FIX: Use the imported Lucide ChevronDown component
		<ChevronDown
			fill={variant === "fill" ? color : "none"}
			height={size}
			stroke={variant === "border" ? color : "none"}
...
export const ChevronUpIcon = (props: IconSvgProps) => {
	...
	return (
		// FIX: Use the imported Lucide ChevronUp component
		<ChevronUp
			fill={variant === "fill" ? color : "none"}
			height={size}
			stroke={variant === "border" ? color : "none"}
...
export const EyeIcon = (props: IconSvgProps) => {
	...
	return (
		<Eye
			height={size}
			stroke={variant === "border" ? color : "none"} // Stroke based on variant
			fill={variant === "fill" ? color : "none"} // Fill based on variant
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={strokeWidth}
			viewBox="0 0 24 24"
...
export const FilterIcon = (props: IconSvgProps) => {
	...
	return (
		<svg
			fill={variant === "fill" ? color : "none"} // Use variant logic
			height={size || height}
			stroke={variant === "border" ? color : "none"} // Use variant logic
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={strokeWidth || (variant === "border" ? 2 : 0)} // Apply strokeWidth if bordered
			viewBox="0 0 24 24"
			width={size || width}
			{...rest}
		>
			<path
				...
				fill={variant === "fill" ? color : "currentColor"} // Corrected fill based on variant
			/>
		</svg>
	);
};
...
export const HamburgerIcon = (props: IconSvgProps) => {
	...
	return (
		<svg
			height={size || height}
			stroke={variant === "border" ? color : "none"} // Corrected stroke based on variant
			fill={variant === "fill" ? color : "none"} // Corrected fill based on variant
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={strokeWidth || (variant === "border" ? 2 : 0)} // Apply strokeWidth if bordered
			viewBox="0 0 24 24"
		...
		>
			...
			<g>
				<path
					...
					fill={variant === "fill" ? color : "currentColor"} // Corrected fill for inner path
				/>
				<path
...
export const InfoIcon = (props: IconSvgProps) => {
	...
	return (
		...
		>
			<path
				d="M12 17V11"
				stroke={variant === "border" ? color : "none"} // Corrected stroke for path
				strokeLinecap="round"
				strokeLinejoin="round"
			...
			<circle
				cx="1"
				cy="1"
				fill={variant === "fill" ? color : "currentColor"} // Corrected fill for circle
				r="1"
	...
	return (
		...
		>
			<path
				...
				fill={variant === "fill" ? color : "#2563eb"} // Corrected fill for path
			/>
			<path
				...
				fill={variant === "fill" ? color : "#38bdf8"} // Corrected fill for path
			/>
		</svg>
	);
};
	...
	return (
		...
		>
			<path
				...
				fill={variant === "fill" ? color : "currentColor"} // Corrected fill for path
			/>
		</svg>
	);
};
	...
	return (
		...
		>
			<path
				...
				stroke={variant === "border" ? color : "currentColor"} // Corrected stroke for path
				strokeLinecap="round"
				strokeLinejoin="round"
				strokeWidth={strokeWidth || 2}
			/>
